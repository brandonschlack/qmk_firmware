 ...
 * ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴───┤
 * │EF+  │H1+│S1+│BR+│ES+│H1+│S2+│   │   │   │   │ ↑ │MNC│ Del │
 * ├─────┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴─────┤
 * │EF-   │H1-│S1-│BR-│ES-│H2-│S2-│   │VlD│Vlu│ ← │ → │   Play │
 * ├──────┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴────┬───┤
...
[_FN1] = LAYOUT_60_hhkb( \
    ...
    EF_INC,  H1_INC,  S1_INC,  BR_INC,  ES_INC,  H2_INC,  S2_INC,  _______, _______, _______, _______, KC_UP,   MC_MSSN,          KC_DELT, \
    EF_DEC,  H1_DEC,  S1_DEC,  BR_DEC,  ES_DEC,  H2_DEC,  S2_DEC,  _______, KC_VOLD, KC_VOLU, KC_LEFT, KC_RGHT,          KC_MPLY,          \
    _______,          RGB_TOG, _______, _______, _______, RESET,   _______, KC_MUTE, KC_MPRV, KC_MNXT, KC_DOWN, PGU_SFT,          _______, \
